...
struct RenderInfo {
  ...
  enum NODE_VIS { RI_NV_NONE, RI_NV_CONSTANT, RI_NV_SOLID_PHI };
  ...
  enum EDGE_CENTER_VIS { RI_ECV_NONE, RI_ECV_CONSTANT };
  EDGE_CENTER_VIS render_edge_centers;

  enum CELL_CENTER_VIS { RI_CCV_NONE, RI_CCV_CONSTANT, RI_CCV_LIQUID_PHI };
